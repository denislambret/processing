...
public class Momentary extends PApplet
{
	...
	public void setup() {
		...
		for (int i=0;i<num;i++) {
			float fx = 0.4f * dim * cos(PConstants.TWO_PI * i / num);
			float fy = 0.4f * dim * sin(PConstants.TWO_PI * i / num);
	...
	public static void main(String[] args) {
		PApplet.main("momentary.Momentary");
	}
